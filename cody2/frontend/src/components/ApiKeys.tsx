...
export const ApiKeys: FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col w-[85%] mx-auto h-full gap-4">
      <div onClick={onBack} className={'w-fit cursor-pointer hover:text-gray-500 underline'}>
        Back
      </div>
      ...
      <p>
        Your API key never gets sent to our servers. You can check the full source code for Cody&nbsp;
        <a
          href={'https://github.com/montelo-org/examples/tree/main/cody'}
          target={'_blank'}
